package volleycom.azhar.volleyrecyclerviewmodel001.activity;
...
import volleycom.azhar.volleyrecyclerviewmodel001.network.ApiClient;
import volleycom.azhar.volleyrecyclerviewmodel001.reciever.NetworkConnectionReciever;
import volleycom.azhar.volleyrecyclerviewmodel001.service.APIService;
...
public class MainActivity extends AppCompatActivity implements NetworkConnectionReciever.ConnectivityRecieverListener {
    ...
    private void findViewById() {
        ...
        showEmployeeUseVolley();
        showEmployeeUseRetrofit();
    }

    private void showEmployeeUseRetrofit() {
        ...
        try {
            ...
            Call<List<Employee>> call=apiService.getUserData();
            call.enqueue(new Callback<List<Employee>>() {
                @Override
                public void onResponse(Call<List<Employee>> call, retrofit2.Response<List<Employee>> response) {


                    Log.d("response", String.valueOf(response));
                    List<Employee> userList=response.body();
                    LinearLayoutManager linearLayoutManager= new LinearLayoutManager(MainActivity.this);
                    RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recyclerview);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    CustomAdapter myAdapter=new CustomAdapter(userList,MainActivity.this);
    ...
    public void showEmployeeUseVolley(){
